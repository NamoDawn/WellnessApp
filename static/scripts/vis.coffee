...
Bubbles = () ->
  ...
  # creating value for the type of symptom 

  # function to define what to display in each bubble
  #  again, abstracted to ease migration to 
  #  a different dataset if desired

  # describing type of symptom
  typeValue = (d) -> d.type

  # scale / severity of experience
  scaleValue = (d) -> d.scale
